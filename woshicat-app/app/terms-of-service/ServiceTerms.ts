export const TermsOfServiceDoc = [
    { 
        header: `Overview`,
        body: `This website is operated by WoShi Cat LLC. Throughout the site, the terms “we”, “us” and “our” refer to WoShi Cat LLC. WoShi Cat LLC offers this website, including all information, tools and Services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here. 
    ...
    { 
        ...
        body: `Certain products or Services may be available exclusively online through the website. These products or Services may have limited quantities and are subject to return or exchange only according to our Refund Policy listed in the Frequently Asked Questions (FAQ) section.
    ...
    { 
        ...
        For more details, please review our Refund Policy listed in the Frequently Asked Questions (FAQ) section.`,
        index: 6,
    },
    { 
    ...
    { 
        header: `SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS`,
    ...
    { 
        header: `SECTION 10 - PERSONAL INFORMATION`,
        body: `Your submission of personal information through the store is governed by our Privacy Policy, which can be viewed `,
        index: 10,
        link: {
            text: 'here: woshicat.com/privacy-policy',
            url: '/privacy-policy'
        },
    },
    { 
    ...
    { 
        ...
        In no case shall WoShi Cat, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers, Service providers or licensors be liable for any injury, loss, claim, or any direct, indirect, incidental, punitive, special, or consequential damages of any kind, including, without limitation lost profits, lost revenue, lost savings, loss of data, replacement costs, or any similar damages, whether based in contract, tort (including negligence), strict liability or otherwise, arising from your use of any of the Service or any products procured using the Service, or for any other claim related in any way to your use of the Service or any product, including, but not limited to, any errors or omissions in any content, or any loss or damage of any kind incurred as a result of the use of the Service or any content (or product) posted, transmitted, or otherwise made available via the Service, even if advised of their possibility. Because some states or jurisdictions do not allow the exclusion or the limitation of liability for consequential or incidental damages, in such states or jurisdictions, our liability shall be limited to the maximum extent permitted by law.
        `,
        index: 13,
    },
    { 
        header: `SECTION 14 - INDEMNIFICATION`,
        body: `You agree to indemnify, defend and hold harmless WoShi Cat and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, Service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.`,
        index: 14,
    },
    { 
    ...
    { 
        header: `SECTION 18 - GOVERNING LAW`,
        body: `These Terms of Service and any separate agreements whereby we provide you Services shall be governed by and construed in accordance with the laws of the United States.
        `,
        index: 18,
    },
    { 
        header: `SECTION 19 - CHANGES TO TERMS OF SERVICE`,
    ...
    { 
        ...
        body: `Questions about the Terms of Service should be sent to us at help@woshicat.com. 
