export const privacyDoc = [
    { 
        header: `Last updated: October 1, 2024`,
        body: `This Privacy Policy describes how WoShi Cat (the "Site", "we", "us", or "our") collects, uses, and discloses your personal information when you visit, use our services, or make a purchase from shop.woshicat.com (the "Site") or otherwise communicate with us regarding the Site (collectively, the "Services"). For purposes of this Privacy Policy, "you" and "your" means you as the user of the Services, whether you are a customer, website visitor, or another individual whose information we have collected pursuant to this Privacy Policy. 
    ...
    { 
        header: `How We Collect and Use Your Personal Information`,
        body: `To provide the Services, we collect and have collected over the past 12 months personal information about you from a variety of sources, as set out below. The information that we collect and use varies depending on how you interact with us. 
    ...
    { 
        header: `What Personal Information We Collect`,
    ...
    { 
        header: `Information We Collect Directly from You`,
        ...
        - Order information, including your name, billing address, shipping address, payment confirmation, email address, and phone number. Account information, including your username, password, security questions and other information used for account security purposes. 
        - Customer support information, including the information you choose to include in communications with us, for example, when sending a message through the Services. 
        Some features of the Services may require you to directly provide us with certain information about yourself. You may elect not to provide this information, but doing so may prevent you from using or accessing these features.`,
        index: 4,
    },
    { 
        header: `Information We Collect about Your Usage`,
    ...
    { 
        header: `Information We Obtain from Third Parties`,
    ...
    { 
        header: `How We Disclose Personal Information`,
    ...
    { 
        header: `Third Party Websites and Links`,
    ...
    { 
        header: `Contact`,
        body: `Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please email us at help@woshicat.com.`,
        index: 16,
    },
]