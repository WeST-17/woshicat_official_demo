...
const ToggleButton = () => {
    ...
    return (
        ...
        <button className="relative inline-block w-10 h-5 flex justify-center items-center">
            <input id="switch-component-1" type="checkbox" className="peer appearance-none w-full h-full bg-stone-400 rounded-full checked:bg-red-900 cursor-pointer transition-colors duration-300" onClick={toggle}/>
