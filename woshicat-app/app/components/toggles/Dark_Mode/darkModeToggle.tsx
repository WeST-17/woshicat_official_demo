    ...
    return (
        <>
            <button className="relative inline-block w-10 h-5 flex justify-center items-center">
                <input id="dark-mode" type="checkbox" className="peer appearance-none w-full h-full bg-stone-400 rounded-full checked:bg-red-900 cursor-pointer transition-colors duration-300" onChange={toggle} checked={darkMode} />
