...
const Header = () => {
    ...
    return (
        <>
            <header className={`fixed top-0 flex justify-center items-center h-[70px] w-full bg-white/90 text-base text-black p-2 z-[2000] transition duration-300`} id="header">
                <Link href={'/'} className="z-[1001] bg-transparent absolute md:left-0 grid grid-flow-col flex justify-center md:justify-start items-center w-64">
                    ...
                    <h1 className="max-md:hidden">WoShi Cat</h1>
                </Link>
