    ...
    return (
        <>
            <header className={`fixed top-0 flex justify-center items-center h-[70px] w-full bg-white/70 hover:bg-white text-base text-black p-2 z-[2002] transition duration-300`} id="header">
                ...
                <div className={`absolute relative w-screen flex justify-start lg:justify-center items-center p-4 transition transition-all duration-500 ease-in-out ${isActive ? "z-[2006]" : "z-[2004]"}`} onClick={activeMenu}>
                    <Navigation />
                </div>
                <CartHeaderIcon />
            </header>
