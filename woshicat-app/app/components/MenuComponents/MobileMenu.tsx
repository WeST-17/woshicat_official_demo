...
const MobileMenu = () => {
    ...
    return (
        <>
        <div className={`bg-black/70 z-0 fixed left-0 top-0 w-[100vw] h-[100vh] transition-all duration-500 ease-in-out ${openMenu ? '' : 'hidden overflow-hidden'}`} ref={overlayRef} />
