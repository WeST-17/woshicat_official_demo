...
const TwoOneRect: React.FC<TwoOneRectProps> = ({ children, link, collectionName }) => {
    ...
    return (
        ...
        <div className="button-hover relative col-span-10 md:col-span-5 overflow-hidden rounded-lg h-full w-full aspect-[9/10]">
          <Link href={link} className="w-full">
            <div className="w-full h-full flex justify-center items-center ">
              {children}
            </div>

            <div className="absolute bottom-0 left-0 p-3 m-3 text-white bg-black/45 w-4/5 z-100">
