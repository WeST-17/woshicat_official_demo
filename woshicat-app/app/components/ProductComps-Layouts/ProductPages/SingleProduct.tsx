...
// --------------------------------------------------------------------------------------------------------------------------
    return (
        ...
        <div className='h-fit w-full text-lg lg:w-4/5 mx-auto flex items-start mb-6 px-2'>
        ...
        <div className='h-fit w-full text-lg lg:w-4/5 mx-auto flex items-start'>
            <ScrollingCarousel addClass='ss' numPerSlide={3} length={6}>
            {recommendations.map((product: any) => (
                <div className='w-full h-full pe-1' key={product.id}>
