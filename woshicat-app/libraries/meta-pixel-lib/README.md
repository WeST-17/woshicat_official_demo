...
> TypeScript implementation of the facebook's pixel script. This is a client-side only library. Edited to add consent functionality - WT, April 2026. Fully based on tanukijs' meta-pixel npm library.
